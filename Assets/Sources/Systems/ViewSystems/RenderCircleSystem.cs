...
public class RenderCircleSystem : ReactiveSystem<GameEntity>
{
    ...
    {
        var matcher = GameMatcher.AllOf(GameMatcher.CircleLine, GameMatcher.CircleCollider);
        return context.CreateCollector(matcher);
    }

    protected override bool Filter(GameEntity entity)
    {
        return entity.hasCircleLine && entity.hasCircleCollider && entity.hasView;
    }
    ...
    protected override void Execute(List<GameEntity> entities)
    {
        foreach (GameEntity e in entities)
        {
            ...
            float radius = e.circleCollider.radius;
